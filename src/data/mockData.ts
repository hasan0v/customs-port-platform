...
export const gemiler = [
  ...
  },
  {
    ...
    bayraq: 'Azərbaycan',
    yuk: 'Qarışıq yük və konteyner',
    tonaj: 12500,
    status: 'Lövbərdə' as GemiStatus,
    istiqamet: 'Gələn' as GemiIstiqameti,
    kanal: 'Kanal 3 (Şimal lövbəri)',
    girisTarixi: '2026-06-25T14:30',
    cixisTarixi: '2026-06-26T09:15',
    ...
    billOfLading: 'BL-245263',
    originalBlSayi: 3,
    dasimaQeydi: 'Clean on board · Freight prepaid',
    gomrukMohuru: 'Azərbaycan Respublikası Dövlət Gömrük Komitəsi',
    beyannameSayi: 38,
    clearances: { DGK: 'approved', DSX: 'approved', DDA: 'approved', AQTA: 'approved', FHN: 'approved' } as const,
    riskDerecesi: 'Aşağı' as const,
    tirTutumu: 0,
